# 获取项目ID<a name="ZH-CN_TOPIC_0101805345"></a>
...
获取项目ID的接口为“GET https://\{Endpoint\}/v3/projects/”，其中\{Endpoint\}为IAM的终端节点，可以从[地区和终端节点](https://developer.huaweicloud.com/endpoint?SMN)获取。接口的认证鉴权请参见[认证鉴权](认证鉴权.md#ZH-CN_TOPIC_0173396107)。
